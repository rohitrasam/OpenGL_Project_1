...
#define SHADER_PATH "D:/Opengl_C/Project_1/res/shaders/002exercise1.shader"

// #define SHADER_PATH "D:/Opengl_C/Project_1/res/shaders/002Shaders.shader"
...
{   
    ...
    */
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        float value = fabs(sin(timeValue));
        // time += 0.0001;
        // Drawing the triangle
        int uniformLocation = glGetUniformLocation(shaderProgram, "ourColor");
        glUseProgram(shaderProgram);
        glUniform4f(uniformLocation, 1.0f, value, 0.0f, 1.0f);
